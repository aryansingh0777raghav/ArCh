...
class SearchBot:
    ...
    async def generate_ai_answer(self, query: str, context: str, sources: list, history: list, api_key: str, model: str = "llama-3.3-70b-versatile") -> dict:
        """
        ...
        for msg in history[-6:]:
            # Clean history of internal JSON structure for the assistant messages
            role = msg["role"]
            content = msg["content"]
